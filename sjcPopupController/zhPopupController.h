...
/// default is YES.(系统设置的优先级比他高)
@property (nonatomic, assign) BOOL impactNeeded;
...
/// 回弹
@property (nonatomic, copy) void (^defaultPopupBlock)(zhPopupController *popupController);
...
/// 手势冲突的处理
@property (nonatomic, copy) BOOL (^gestureRecognizerShouldReceiveTouchBlock)(UIGestureRecognizer *gestureRecognizer, UITouch *touch, zhPopupController *popupController);

/// 放手就能关闭的状态,以及拖拽出来的百分比
@property (nonatomic, copy) void (^canDissmissBlock)(zhPopupController *popupController, CGFloat pullPercent, BOOL canDissmiss);
